...
import assets, { messagesDummyData } from '../assets/assests'
...
const ChatContainer = ({selecteduser,setselectedUser}) => {
  ...
  return  selecteduser ? (
    ...
    {/*----------------------------------------chat area-------------------------------*/}
    <div className= 'flex flex-col h-[calc(100%-120px)] over-flow-y-scroll p-3 pb-6'>
          ...
          {msg.image ? (
            ...
            <p className ={`p-2 max-w-[200px] md:text-sm font-light
              rounded-lg mb-8 break-all bg-violet-500/30 text-white ${msg.
                senderId === '680f50aaf10f3cd28382ecf2' ? 'rounded-br-none' : 
