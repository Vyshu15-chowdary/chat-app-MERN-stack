    ...
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        <form  onsubmit= {handleSubmit}className='flex flex-col gap-5 p-10 flex-1'>
          ...
          <input type='text' required placeholder='Your name' className='p-2 border border-gray-500 rounded-md focus:ring-2
          focus:ring-violet-500'/>
          
  
      <textarea  onchange= {(e)=>setBio(e.target.value)} value={bio}  placeholder = "Write profile bio" required className = "p-2 border border-gray-500 rounded-md focus:outline-none focus:ring-focus:ring-violet-500" rows={4}></textarea>
